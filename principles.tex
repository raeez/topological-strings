...
enters the manuscript as algebraic theorem data.  Together they specify
...
\]
The finite and completed CE/PV theorem is the cochain identity
\[
...
primitive \(\eta(f)=-[f]_0\) could live.  The scalar QME acceptance
criterion is therefore explicit: choose a central-character primitive,
a balanced-supertrace model, or a closed-exchange contribution
\(W_{\mathrm{ext}}\) whose leading class satisfies
\[
