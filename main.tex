...
\title{\texorpdfstring{Remarks on mixed holomorphic topological strings\\
\large Formal local Hamiltonian BF theory, reduced CE/PV central operations, and a Dirac brane probe on \(\R^2_{\mathrm{top}}\times\C^2_{\mathrm{hol}}\)}
{Remarks on mixed holomorphic topological strings:
Formal local Hamiltonian BF theory, reduced CE/PV central operations, and a Dirac brane probe on R2 top x C2 hol}}
\date{April 30, 2026}
