...
\begin{prop}[Costello--Li 2012 hypothesis separation for the local
  ...
  \begin{enumerate}
    \item[(S1)] \emph{Non-compactness.} $\C^2$ is not compact.
...
\label{cor:costello-li-input-coefficient-endpoint}
  The Costello--Li 2012 BV-cohomology vanishing theorem supplies a pure
  closed BCOV template.  The unreduced Tate-coefficient cotangent lift
...
\begin{proof}
  ...
  BV-cohomology vanishing of \cite{costello-li-quantum-bcov} is stated
  for different geometric and coefficient data.  Its conclusion contains
...
\label{thm:costello-li-no-coefficient-endpoint}
  The Costello--Li 2012 vanishing theorem
...
\begin{thm}[Costello--Li extension criterion for the mixed coefficient endpoint]\label{rmk:t4-four-missing}
...
\begin{rmk}[Matched-conventions boundary]\label{rmk:t4-matched-conventions-boundary}
  ...
  Borcherds--BKM frontier require their own matched-conventions data.
